...
The use of WGS84 to place objects on the Earth's surface is a common practice but there are other methods available. In this instance WGS84 will be used as the CRS and is set below for future use.
```{r projections}
