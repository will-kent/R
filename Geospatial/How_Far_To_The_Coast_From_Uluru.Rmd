...
## Introduction
Uluru, Ayers Rock or simply "the Rock" is a large sandstone monolith located in central Australia. It is thought to have formed approximately 550 million years ago and stands 348 metres above the surrounding plain. It is listed as a UNESCO World Heritage Site.
...
## The Coastline
The coastline forms a geographic boundary between land and sea and fortunately for this task there is a publicly available shape file that contains the coast line in a spatial object. The shape file is available on the <http://www.naturalearthdata.com> website.
...
paste("Distance from Uluru to the sea: ",dist_line[1]/1000)
paste("The location of the closest point on the coast to Uluru is at: ",closest_longitude," ",closest_latitude)
```

The answer to the original question has been obtained. Uluru is 679.35 kilometres from the sea and the closest point is located on the South Australian coast at the head of the Great Australian Bight.
